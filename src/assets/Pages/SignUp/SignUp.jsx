...
const SignUp = () => {
   ...
   if(res.data.success){
    ...
    return (
      <>
       ...
       <div className="flex justify-center text-[#DDE6ED] items-center my-28">
  ...
  <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100">
	<h1 className="text-2xl font-bold text-center">Login</h1>
		...
		<div className="space-y-1 text-sm">
			<label  className="block dark:text-gray-400">Profession</label>
			<input {...register("profession", { required: true })} type="text" name="profession" id="profession" placeholder="profession" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
            {errors.name && <span>This field is required</span>}
		</div>
		<div className="space-y-1 text-sm">
...
<input {...register("photo", { required: true })} className="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file"/>
	...
	<p className="text-xs text-center sm:px-6 dark:text-gray-400">Already have an account?
		<a rel="noopener noreferrer" href="#" className="underline dark:text-gray-100">Login </a>
	</p>
</div>
